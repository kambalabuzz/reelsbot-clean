-- =====================================================
-- ReelsBot Database - Cleanup and Fresh Install
-- First drops old triggers/policies, then installs fresh schema
-- =====================================================

-- =====================================================
-- PART 1: CLEANUP OLD TRIGGERS AND POLICIES
-- =====================================================

-- Drop all existing triggers that might reference old tables
...
-- =====================================================
-- PART 2: FRESH SCHEMA INSTALLATION
-- =====================================================
...
-- Add missing columns to existing series table
...
-- Add missing columns to existing assembly_jobs table
